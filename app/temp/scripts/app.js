...
new _RevealOnScroll2.default((0, _jquery2.default)('.feature-item'), "70%");
...
var MobileMenu = function () {
	...
	_createClass(MobileMenu, [{
		...
		value: function toggleMenu() {
			this.menuContent.toggleClass('site-header__menu-content--show');
			this.siteHeader.toggleClass('site-header--show');
			...
			this.itemsToReveal.each(function () {
				...
				new Waypoint({
					...
					handler: function handler() {
						(0, _jquery2.default)(currentItem).addClass("reveal-item--show");
					},
